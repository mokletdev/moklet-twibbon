...
export const HowItWorks = () => {
  ...
  const steps = [
    {
      title: "Unggah Frame-mu",
      description: "Pilih file PNG yang akan menimpa gambarmu",
      icon: <FileImage className="w-6 h-6" />,
      color: "from-blue-500 to-indigo-600",
    },
    {
      title: "Sesuaikan",
      description: "Sesuaikan gambarmu dengan frame yang sudah di-upload",
    ...
    },
    {
      ...
      description:
        "Unduh twibbon tanpa watermark-mu dan bagikan ke media sosial-mu",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Buat twibbon kustom-mu dalam 3 langkah mudah
          </motion.p>
        </motion.div>
