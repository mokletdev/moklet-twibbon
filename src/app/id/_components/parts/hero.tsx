          ...
          >
            ...
            >
              ...
              <span className="block mt-1">
                Buat Twibbon Gratis Tanpa Watermark
              </span>
            </motion.h1>
            ...
            >
              Buat twibbon kamu tanpa watermark sekarang! Powered by{" "}
              <Link
                target="_blank"
            ...
            >
              ...
              <motion.label
                ...
                whileTap={{ scale: 0.98 }}
              >
                <Upload size={18} /> {fileName ?? "Pilih frame"}
              </motion.label>
              ...
              {fileName && (
                ...
                >
                  <LinkButton
                    ...
                    href="/id/go?slug=custom-twibbon"
                  >
                    Buat twibbon <ArrowRight className="ml-2" size={18} />
                  </LinkButton>
                </motion.div>
              )}
            </motion.div>
          ...
          >
            ...
            <div className="absolute bottom-0 inset-x-0 h-24 bg-gradient-to-t from-primary-500/20 to-transparent flex items-end p-6">
              <p className="text-primary-500 text-lg font-bold">
                Twibbon Profesional dengan Instan
              </p>
            </div>
          </motion.div>
        </div>
