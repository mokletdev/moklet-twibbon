        ...
        if (/image.*/.exec(file.type)) {
          ...
          canvasHook
            ...
            .catch((error) => {
              ...
              setIsLoading(false);
              toast.error("Failed to load image. Mohon coba kembali.");
            });
        } else {
  ...
  const handleDownload = useCallback(() => {
    ...
    try {
      ...
      if (data) {
        ...
        toast.error("Gagal mengunduh. Mohon coba kembali.");
      }
    } catch (error) {
      toast.error("Kesalahan terjadi. Mohon coba kembali.");
    } finally {
  ...
  useEffect(() => {
    const initializeFrame = async () => {
      ...
      try {
        ...
        toast.error("Gagal memuat frame. Mohon coba kembali.");
      } finally {
        setIsLoading(false);
      }
    };
